...
clientsList.addEventListener('mousedown', (e) => {
  ...
  clientsList.style.cursor = 'grabbing'; // Change cursor when dragging
});

clientsList.addEventListener('mouseleave', () => {
  isMouseDown = false;
  clientsList.style.cursor = 'grab'; // Change cursor back when not dragging
});
...
clientsList.addEventListener('mousemove', (e) => {
  ...
  const walk = (x - startX) * 2; // Control the speed of scrolling
